...
<script type="text/javascript">
    ...
    function purchaseDetails(purchase){
        ...
        var htmlfooter = '<p><strong>{{trans("file.Note")}}:</strong> '+purchase[22]+'</p>';
